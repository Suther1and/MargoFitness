...
export const MobileProfileCard = memo(function MobileProfileCard({ profile, onEditClick, tabs }: MobileProfileCardProps) {
  ...
  return (
    <div className="w-full relative group">
      ...
      <div className="sub-card w-full rounded-[2.5rem] relative group min-h-[200px] flex flex-col overflow-hidden">
        ...
        {/* Ambient Glows */}
        <div className={cn("absolute -right-10 -top-10 w-48 h-48 rounded-full pointer-events-none opacity-20", subStyles.glow)}></div>
        <div className={cn("absolute -left-10 bottom-0 w-40 h-40 rounded-full pointer-events-none opacity-10", subStyles.glow)}></div>
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          {/* Integrated Tabs */}
          {tabs && (
            <div className="mt-auto bg-white/[0.04] relative">
