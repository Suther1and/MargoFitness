            ...
            <div className="sticky top-0 z-30 pt-4 px-4 sm:px-6 pb-2 pointer-events-none">
              <div className="flex items-center justify-between bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-2xl p-3 shadow-2xl pointer-events-auto">
                <div className="flex items-center gap-4">
                  <div className={cn(
                    "w-10 h-10 rounded-xl border flex items-center justify-center shadow-inner transition-colors duration-500 relative bg-[#0d0d0f]",
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] font-black uppercase tracking-[0.2em] font-montserrat leading-none mb-1.5 text-white/20">
                      Личная эволюция
                    </span>
                    <div className="flex items-center gap-4">
                      ...
                      {/* Minimalist Segmented Progress Indicator */}
                      <div className="flex items-center gap-3 pl-4 border-l border-white/5">
                        ...
                        <span className="text-[11px] font-black text-white/40 font-oswald italic tracking-tighter">
                          {percentage}%
                        </span>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-col items-center gap-2 transition-all duration-500 relative group/item hover:scale-105 active:scale-95">
                        <div className="aspect-square w-[75%] sm:w-[80%] flex items-center justify-center relative z-10">
                          ...
                          <div className={cn(
                            ...
                            "brightness-[0.8] opacity-20 group-hover/item:opacity-30"
                          )}>
            ...
            >
              ...
              >
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: getGlowFromColorClass(selectedAchievement.color_class).replace('0.3', '0.15') 
                  }}
                />
                          ...
                          <div className="flex flex-col items-end relative z-10">
                            <span className="text-[10px] font-black uppercase tracking-widest mb-1 flex items-center gap-1.5">
                              <div className={cn(
                                ...
                                getCategoryStyles(selectedAchievement.category).glow,
                                getCategoryStyles(selectedAchievement.category).shadow.replace('shadow-[', 'shadow-[0_0_10px_')
                              )} />
                              Разблокировано
                            </span>
