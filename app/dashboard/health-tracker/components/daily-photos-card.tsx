    ...
    <div className="rounded-[2.5rem] border border-white/5 bg-[#121214]/40 backdrop-blur-xl p-6 hover:border-white/10 transition-all duration-300">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-black text-white uppercase tracking-widest">Фото прогресса</h3>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <button className="aspect-square rounded-xl bg-white/5 border border-dashed border-white/10 flex flex-col items-center justify-center gap-1 hover:bg-white/10 hover:border-white/20 transition-all group">
          ...
          <span className="text-[8px] font-black text-white/10 uppercase group-hover:text-white/20">Добавить</span>
        </button>
      </div>
    </div>
  )
