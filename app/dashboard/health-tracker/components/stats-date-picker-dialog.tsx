...
export function StatsDatePickerDialog({ 
  ...
  // Standalone версия для десктопа (без Dialog)
  if (standalone) {
    return (
      <div className="w-full overflow-hidden bg-[#121214]/95 backdrop-blur-2xl border-white/10 border-none">
