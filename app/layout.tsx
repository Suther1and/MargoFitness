...
export default function RootLayout({
  ...
  return (
    <html lang="ru" suppressHydrationWarning>
      ...
      >
        <div className="relative w-full xl:max-w-[96rem] min-h-screen xl:min-h-[calc(100vh-4rem)] xl:rounded-[3rem] overflow-hidden">
          <NavbarNew />
          <main className="relative w-full overflow-x-hidden" style={{ background: '#0a0a0f' }}>
