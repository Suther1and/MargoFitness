...
-- Также переименовывает "Коллекционер" (habits) в "Палитра привычек"
-- ============================================

-- Переименование достижения для избежания конфликта имен
UPDATE achievements 
SET title = 'Палитра привычек'
WHERE title = 'Коллекционер' 
  AND category = 'habits' 
  AND metadata->>'type' = 'habits_created';
...
UPDATE achievements 
SET icon_url = '/achievements/habit-palette.png' 
WHERE title = 'Палитра привычек';
