      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-0">
        ...
        <div className="space-y-6 mb-14 text-left">
          <p className="text-lg md:text-xl text-white/70 leading-relaxed">
            Одна из лучших вещей в домашних тренировках — тебе не нужен зал,
            забитый тренажёрами. Все программы MargoFitness построены на
            минимальном инвентаре, который помещается в угол комнаты.
          </p>
          <p className="text-lg md:text-xl text-white/70 leading-relaxed">
            Но «минимальный» не значит «любой». Правильно подобранные гантели
            дадут результат. Неправильные — испортят технику и отобьют желание.
            В этом гиде — конкретные рекомендации: что именно купить, какой вес
            выбрать, на чём можно сэкономить, а на чём нельзя.
          </p>
        </div>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-base text-white/40 mb-8">
            Весь инвентарь разделён на три категории. Начни с обязательного —
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/60 leading-relaxed mb-8">
            Самый частый вопрос: «Какой вес мне нужен?». Ответ зависит от
            группы мышц — верх и низ тела работают с разным весом.
          </p>
