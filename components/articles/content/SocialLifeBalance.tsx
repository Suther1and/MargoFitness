      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-0">
        ...
        <div className="space-y-6 mb-14 text-left">
          <p className="text-lg md:text-xl text-white/75 leading-relaxed">
            ...
            жизнь подбрасывает события, которые, казалось бы, <span className="text-white/90 font-bold">несовместимы</span> с
            режимом.
          </p>
          <p className="text-lg md:text-xl text-white/75 leading-relaxed">
            И вот ключевое: <span className="text-amber-400/85 font-bold underline decoration-amber-500/30 underline-offset-4">они совместимы</span>. Режим, который рушится от одного
            ужина в ресторане - это не режим, а тюрьма. А я строю MargoFitness
            на другом принципе: фитнес <span className="text-white/90 font-bold">встраивается в жизнь</span>, а не заменяет её.
          </p>
        </div>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            Главная ошибка - отношение <span className="text-white/85 font-bold italic">«или я на диете, или я ем что хочу»</span>.
            Такое чёрно-белое мышление приводит к тому, что ты либо сидишь с
            салатом и злишься, либо срываешься на весь стол.
          </p>

          <p className="text-lg text-white/70 leading-relaxed mb-8">
            В ресторане работает <span className="text-amber-400/85 font-semibold">система «навигации»</span> - простые правила, которые
            позволяют получить удовольствие от еды и <span className="text-white/85 font-bold underline decoration-white/15 underline-offset-4">не откатиться</span> в прогрессе.
          </p>
          ...
          <p className="text-lg text-white/70 leading-relaxed mt-8 mb-6">
            ...
            <span className="text-white/85 font-bold"> осознанно выбирать</span>: что я хочу, что мне нужно, и от чего я могу
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            Алкоголь - не абсолютное зло. Но если ты тренируешься ради результата, тебе нужно понимать, что
            <span className="text-amber-400/85 font-bold"> именно он делает</span> с твоим телом.
          </p>

          <p className="text-lg text-white/70 leading-relaxed mb-8">
            Вот что происходит с организмом после того, как ты <span className="text-white/85 font-bold underline decoration-white/15 underline-offset-4">выпила</span>:
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            Гости - это другая ситуация. В гостях ты ешь то, что приготовил хозяин. И здесь включается
            <span className="text-amber-400/85 font-semibold"> социальное давление</span>: «Попробуй вот это», «Почему так мало ешь?».
          </p>

          <p className="text-lg text-white/70 leading-relaxed mb-8">
            Давай разделим это на <span className="text-white/85 font-bold underline decoration-white/15 underline-offset-4">два сценария</span> - ты в гостях и гости у тебя.
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            Отпуск - это самый длинный перерыв в режиме. Хорошая новость: за 7-14 дней ты <span className="text-white/85 font-bold">физически не потеряешь</span> мышцы.
          </p>

          <p className="text-lg text-white/70 leading-relaxed mb-8">
            Плохая новость: ты можешь набрать <span className="text-amber-400/85 font-bold underline decoration-amber-500/20 underline-offset-4">2-4 кг</span> за счёт воды и гликогена. Стратегия отпуска - <span className="text-white/85 font-semibold italic">не контроль, а баланс</span>.
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            Неделя отпуска. Три корпоратива подряд. Так или иначе, будут периоды, когда ты отклонишься от режима. И вот
            здесь самая <span className="text-white/85 font-bold">опасная ловушка</span> - не сам «загул», а то, что ты делаешь <span className="text-amber-400/85 font-bold underline decoration-amber-500/20 underline-offset-4">после</span>.
          </p>
