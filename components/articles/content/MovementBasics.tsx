      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-0">
        ...
        <div className="space-y-6 mb-14 text-left">
          <p className="text-lg md:text-xl text-white/70 leading-relaxed">
            ...
            выглядеть пугающе. Незнакомые названия, непонятные паттерны. Кажется,
            что нужно заучить десятки движений, прежде чем начать.
          </p>
          <p className="text-lg md:text-xl text-white/70 leading-relaxed">
            Это не так. Все упражнения в наших тренировках построены на
            6 фундаментальных движениях. Каждое «сложное» упражнение — это
            вариация базового. Понимая эти 6 паттернов, ты автоматически
            понимаешь структуру любой тренировки. Эта статья — твоя карта перед
            стартом.
          </p>
        </div>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/60 leading-relaxed mb-6">
            ...
            приседать, наклоняться, толкать, тянуть, стабилизировать корпус и
            ...
            сбалансированную нагрузку на всё тело.
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/60 leading-relaxed mb-6">
            ...
            на платформе. Это снимает тревогу «а что дальше?» и позволяет
          ...
          <p className="text-lg text-white/60 leading-relaxed mt-8">
            Каждая неделя — это новая программа из 2–3 тренировочных сессий.
            Каждая сессия содержит 4–6 упражнений, подобранных так, чтобы
            задействовать разные группы мышц и разные паттерны движения. Ты
            не решаешь, что делать — программа уже составлена. Твоя задача —
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/60 leading-relaxed mb-6">
            Есть принципы, которые универсальны для 90% упражнений. Запомни эти
            5 точек — и ты будешь выполнять любое движение безопаснее и
            эффективнее с первого подхода.
          </p>

          <ControlPointsGrid />

          <p className="text-lg text-white/60 leading-relaxed mt-8">
            Эти 5 принципов — не абстрактные правила. Они физически защищают
            твои суставы и позвоночник от нагрузок, к которым они не готовы. Со
            временем контроль станет автоматическим — как переключение передач у
            опытного водителя.
          </p>
        </section>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/60 leading-relaxed mb-6">
            ...
            У каждого базового движения есть вариации разной сложности. Понимая
            эту логику, ты не будешь теряться при встрече с новым упражнением —
            потому что узнаешь в нём знакомый паттерн.
          </p>

          <p className="text-lg text-white/60 leading-relaxed mb-8">
            Вот как выглядят вариации на примере приседаний:
          </p>

          <ProgressionLadder />

          <p className="text-lg text-white/60 leading-relaxed mt-8 mb-6">
            Та же логика работает в каждом паттерне. Выпады: на месте →
            с шагом → назад → болгарские → с гантелями. Планка: классическая
            → на прямых руках → с подъёмом ноги → боковая → динамическая.
            Когда ты встречаешь незнакомое название в тренировке — это почти
            всегда вариация того, что ты уже делала.
          </p>
