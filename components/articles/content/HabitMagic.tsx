      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-0">
        ...
        <div className="space-y-6 mb-14 text-left">
          <p className="text-lg md:text-xl text-white/75 leading-relaxed">
            Каждый январь - одна и та же история. Миллионы людей клянутся себе: «В этот раз точно».
            А через 6 недель <span className="text-white/90 font-bold">50%</span> из них уже бросили. К концу года - до 80%.
          </p>
          <p className="text-lg md:text-xl text-white/75 leading-relaxed">
            И дело не в лени. Люди пытаются тренироваться через <span className="text-white/90 font-bold underline decoration-white/15 underline-offset-4">силу воли</span> - а она работает как аккумулятор. Те, кто тренируются годами, просто превратили тренировку в <span className="text-rose-400/85 font-bold">привычку</span> - действие, которое не требует волевого решения.
          </p>
        </div>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-8">
            Главная причина: люди полагаются на <span className="text-white/85 font-bold italic">мотивацию</span> вместо системы.
            Мотивация - это эмоция. Она приходит и уходит. Привычка - это
            <span className="text-rose-400/85 font-bold underline decoration-rose-500/20 underline-offset-4"> автопилот</span>. Она работает даже когда настроения нет.
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-6">
            «Привычка формируется за 21 день» - это миф. Мета-анализ показал
            реальную картину: <span className="text-rose-400/85 font-bold">66 дней</span> в среднем требуется для полной автоматизации действия.
          </p>
        ...
        <section className="mb-14 text-left">
          ...
          <p className="text-lg text-white/70 leading-relaxed mb-8">
            Главная причина, по которой люди бросают после пропуска - <span className="text-white/85 font-bold">стыд</span>.
            Это когнитивное искажение называется <span className="text-rose-400/85 font-semibold italic underline decoration-rose-500/20 underline-offset-4">«эффект какого чёрта»</span>.
          </p>
