      ...
      <nav className="backdrop-blur-xl rounded-full shadow-2xl shadow-black/30" style={{
        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4 gap-4">
          ...
          {profile ? (
            ...
            <Link href="/auth" className="uppercase hover:opacity-80 transition-all flex text-xs font-semibold tracking-wider rounded-full py-2 px-4 md:px-5 gap-2 items-center backdrop-blur flex-shrink-0 active:scale-95" style={{
              color: colors.textPrimary,
              border: `1px solid ${colors.cardBorder}`,
              background: `${colors.textPrimary}0D`,
            }}>
