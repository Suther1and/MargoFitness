...
export function SubscriptionUpgradeModal({ open, onOpenChange, currentTier, currentExpires, userId }: UpgradeModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[760px] w-[95vw] md:h-[620px] bg-[#1a1a24]/95 border-white/10 text-white p-0 overflow-hidden shadow-2xl ring-1 ring-white/10 backdrop-blur-xl max-h-[90vh] flex flex-col md:flex-row rounded-3xl transition-all duration-300">
        ...
        <AnimatePresence mode="wait" initial={false}>
          {loading ? (
            ...
            >
              ...
              <div className="md:w-[280px] bg-gradient-to-b from-purple-500/10 via-purple-900/5 to-transparent pt-6 px-8 pb-8 flex-shrink-0 relative overflow-hidden border-b md:border-b-0 md:border-r border-white/5 h-[200px] md:h-auto">
              ...
              <div className="flex-1 px-6 pt-5 pb-6 md:px-10 md:pt-7 md:pb-10 animate-pulse flex flex-col h-full">
                <div className="h-10 bg-white/5 rounded-xl mb-5" />
                <div className="h-20 bg-white/5 rounded-3xl mb-5" />
                <div className="grid grid-cols-2 gap-3 mb-5">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="h-20 md:h-24 bg-white/5 rounded-[22px]" />
                  ))}
                </div>
                <div className="mt-auto h-28 bg-white/5 rounded-3xl" />
              </div>
            </motion.div>
          ) : (
            <motion.div 
            ...
            >
              ...
              {/* Левая панель */}
              <div 
                className={`md:w-[280px] pt-6 px-8 pb-8 bg-gradient-to-b ${currentConfig?.gradient || 'from-purple-500/10'} to-transparent border-b md:border-b-0 md:border-r border-white/5 flex-shrink-0 relative overflow-hidden transition-all duration-500`}
              >
                {/* Фоновые эффекты */}
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="space-y-4 hidden md:block flex-1">
                    ...
                    <div className="mt-auto space-y-2 pt-4">
                      {[
                        { icon: Zap, text: 'Моментальный доступ', color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/10' },
                        { icon: ArrowRight, text: 'Умная конвертация', color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/10' },
              ...
              {/* Правая панель */}
              <div className="flex-1 px-6 pt-5 pb-6 md:px-10 md:pt-7 md:pb-10 flex flex-col overflow-hidden min-h-0">
              {/* Табы тарифов */}
              <div className="flex p-1.5 bg-gradient-to-b from-white/[0.08] to-white/[0.04] rounded-2xl border border-white/10 mb-5">
                {availableTiersData.map(t => {
                  ...
                  return (
                    <button
                      ...
                      className={`
                        flex-1 py-2.5 px-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-200
                        ${isSelected 
              ...
              <div className="mb-5">
                ...
                <div className="flex items-center gap-4 p-3.5 rounded-3xl bg-white/[0.02] border border-white/5 relative w-full">
              ...
              <div className="mb-5">
                <div className="rounded-3xl bg-gradient-to-b from-white/[0.05] to-white/[0.01] ring-1 ring-white/10 p-3 backdrop-blur-sm">
                    ...
                    {products.map((p, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`
                            relative p-3.5 md:p-4 rounded-2xl md:rounded-[22px] text-left border transition-all duration-200
                            ${isSelected 
                        ...
                        >
                          ...
                          <p className={`
                            text-[10px] font-bold uppercase mb-0.5 tracking-wider transition-colors
                            ${isSelected ? currentConfig?.color : 'text-white/40'}
                          `}>
                            {p.duration_months} мес.
                          </p>
                          <p className="text-2xl md:text-2xl font-oswald font-bold text-white">
              ...
              <div className="mt-auto pt-4 border-t border-white/5">
                <div className="rounded-3xl bg-gradient-to-b from-white/[0.06] to-white/[0.02] ring-1 ring-white/10 p-4 relative backdrop-blur-sm mb-4 overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-baseline gap-2">
                        ...
                        <div className="flex flex-col leading-none">
                          ...
                          <span className="text-[9px] font-medium text-white/20 mt-0.5 whitespace-nowrap">
                    ...
                    <div className="flex items-center gap-2.5 py-1.5 px-3 rounded-2xl bg-white/[0.04] border border-white/10">
                      <div className="text-center">
                        <p className="text-[9px] font-bold text-white/20 uppercase mb-0.5 whitespace-nowrap">Конв.</p>
                        <p className={`font-oswald font-bold ${currentConfig?.color} text-lg leading-none`}>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-white font-oswald font-bold text-lg leading-none">
                ...
                <button
                  ...
                  className={`
                    w-full py-3.5 md:py-4 rounded-2xl text-white font-bold text-xs uppercase tracking-widest
